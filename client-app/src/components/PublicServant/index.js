...
import axios from "axios";
  ...
  const PublicServant = () => {
    ...
    const [activeLink, setActiveLink] = useState('Public Servants');
        ...
        <td>
          ...
          <Popover width={300} trapFocus position="bottom" withArrow shadow="md">
                    ...
                    <Popover.Dropdown sx={(theme) => ({ background: theme.colorScheme === 'dark' ? theme.colors.dark[7] : theme.white })}>
                        ...
                        <TextInput value={editdepartment} onChange={(event) => setEditdepartment(event.currentTarget.value)} label="Enter department" placeholder="" size="xs" />
        ...
        <div className='container-d' >
          ...
          <div className='users'>
            ...
            <div style={{width:"100%",display:"flex",justifyContent:"space between"}}>
                <Popover width={300} trapFocus position="bottom" withArrow shadow="md">
                    <Popover.Target>
                        <Button>Add new public servant</Button>
                    </Popover.Target>
                    <Popover.Dropdown sx={(theme) => ({ background: theme.colorScheme === 'dark' ? theme.colors.dark[7] : theme.white })}>
                        ...
                        <TextInput value={department} onChange={(event) => setDepartment(event.currentTarget.value)} label="Department" placeholder="Dept5" size="xs" />
                        <div style={{marginTop:"10px"}}> 
